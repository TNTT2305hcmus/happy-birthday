...
assert.equal(cakeScene.group.scale.x, 0.5)
assert.equal(cakeScene.group.position.y, -1.08)
cakeScene.resize({ height: 900, width: 1_440 })
assert.equal(cakeScene.group.position.x, 1.62)
assert.equal(cakeScene.group.scale.x, 0.76)
