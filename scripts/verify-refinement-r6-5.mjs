...
const completeDrawnText = drawnText.join(' ')
assert.ok(completeDrawnText.includes(content.copy.salutation))
assert.ok(completeDrawnText.includes(content.copy.signOff))
assert.ok(completeDrawnText.includes(content.copy.signature))
assert.ok(content.sentences.every((sentence) => completeDrawnText.includes(sentence)))
