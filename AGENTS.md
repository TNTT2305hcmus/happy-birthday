...
(kỹ thuật/roadmap) trước khi code.
...
2. Xác định task thuộc Phase nào trong `PLANNING.md`. Nếu là phase mới, cập nhật roadmap trước
   khi code.
3. Code xong một phase → tự kiểm thử luồng scroll/tương tác liên quan → báo cáo ngắn gọn phần đã
   xong, phần còn thiếu, và đề xuất bước tiếp theo.
4. Cập nhật `PLANNING.md` (đánh dấu checklist) sau khi hoàn thành mỗi phase.
